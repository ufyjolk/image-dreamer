...
def deepdream(net, base_img, iter_n=15, octave_n=8, octave_scale=1.4, end='inception_3a/5x5_reduce', clip=True, **step_params): #"end='inception_3a/5x5'" was in the last version
